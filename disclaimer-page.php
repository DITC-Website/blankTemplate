<?php /* Template Name: Disclaimer Page */ ?>
<?php get_header(); ?>
  ...
  <section>
    <div class="container">
      <div class="col-md-12">
        ...
        <ul>
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer)
        ...
        <p>In no event shall the Company be liable for any special, direct, indirect, consequential, or incidental
          ...
          This Disclaimer has been created with the help of the Disclaimer Generator.</p>
        ...
        <p>The information on the Service is provided with the understanding that the Company is not herein engaged in
          ...
          a substitute for consultation with professional accounting, tax, legal, or other competent advisers.</p>
